  ...
  <!--<div class="app-container">-->
    <!--<el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="88px">-->
      ...
      <!--<el-form-item label="平台流水" prop="paySerNo">-->
        ...
        <!--/>-->
      <!--</el-form-item>-->
      <!--<el-form-item label="挂接协议号" prop="signNo">-->
        <!--<el-input-->
    ...
    <!--<el-table v-loading="loading" :data="signjrnList" @selection-change="handleSelectionChange">-->
      ...
      <!--<el-table-column label="管理类型" align="center" prop="manageType" :formatter="managetypeFormat"-->
                       <!--v-if="columns[7].visible"/>-->
      <!--<el-table-column label="签约类型" align="center" prop="signType" :formatter="signtypeFormat"-->
      ...
      <!--<el-table-column label="业务处理状态" align="center" prop="trxStatus" :formatter="trxstatusFormat"-->
      ...
      <!--<el-table-column label="钱包类型" align="center" prop="walletType" :formatter="wallettypeFormat"-->
                       <!--v-if="columns[28].visible"/>-->
      <!--<el-table-column label="钱包等级" align="center" prop="walletLevel" :formatter="walletlevelFormat"-->
