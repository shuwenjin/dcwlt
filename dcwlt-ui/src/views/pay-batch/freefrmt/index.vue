  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="平台日期" prop="payDate">
        <el-date-picker clearable size="small" v-model="queryParams.payDate" type="date" value-format="yyyy-MM-dd"
          placeholder="选择平台日期">
        </el-date-picker>
      </el-form-item>
      ...
      <el-form-item label="报文方向" prop="drct">
        <el-select v-model="queryParams.drct" placeholder="请选择报文方向" clearable size="small">
          <el-option v-for="dict in drctOptions" :key="dict.dictValue" :label="dict.dictLabel"
            :value="dict.dictValue" />
        </el-select>
      </el-form-item>
      <el-form-item label="发起机构" prop="instgDrctPty">
        <el-input v-model="queryParams.instgDrctPty" placeholder="请输入发起机构" clearable size="small"
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="接收机构" prop="instdDrctPty">
        <el-input v-model="queryParams.instdDrctPty" placeholder="请输入接收机构" clearable size="small"
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item>
...
<!--    v-hasPermi="['system:nonf:add']"-->
      ...
      <el-col :span="1.5">
        ...
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['system:nonf:export']">导出
        </el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="nonfList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="平台日期" align="center" prop="payDate" v-if="columns[1].visible"
        :show-overflow-tooltip="true" />
      ...
      <el-table-column label="报文编号" align="center" prop="pkgNo" v-if="columns[4].visible"
        :show-overflow-tooltip="true" />
      <el-table-column label="报文方向" align="center" prop="drct" v-if="columns[5].visible"
        :show-overflow-tooltip="true" />
          ...
          <el-col :span="24">
            <el-form-item label="接收机构" prop="instdDrctPty">
              <el-select v-model.trim="form.instdDrctPty" placeholder="请选择接收机构" clearable size="small">
                <el-option v-for="dict in partList" :key="dict.partyID" :value="dict.partyID" :label="dict.partyID">
        ...
        this.$refs["form"].validate(valid => {
          if (valid) {
            if (this.form.msgId != null) {
              ...
              let tlrNO = "11";
              //
              pymtFrdmFmtMsgSnd(tlrNO, this.form.messageContext, this.form.instdDrctPty).then(response => {
                this.msgSuccess("发送自由格式成功");
                this.open = false;
                this.getList();
              });
            }
