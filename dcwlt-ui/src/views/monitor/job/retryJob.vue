<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="jobList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="失败重试cron" align="center" prop="retryCron" v-if="columns[4].visible" />
      <el-table-column label="重试成功状态" align="center" v-if="columns[5].visible">
      ...
      <el-table-column label="重试最大次数" align="center" prop="retryMaxNum" v-if="columns[6].visible" />
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: 4, label: `失败重试cron`, visible: true },
        { key: 5, label: `重试成功状态`, visible: true },
        { key: 6, label: `重试最大次数`, visible: true },
      ],
      // 表单参数
      form: {},
      // 表单校验
