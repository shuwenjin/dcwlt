...
import com.dcits.dcpsclient.controller.SendMsgController;
...
public class DcepServiceUtil {
    ...
    public static String getDcepServiceRsp(String msgType){
        if(map.size()==0){
            map.put("dcep.933.001.01", receive902From933().toJSONString());
            map.put("dcep.801.001.01", receive802From801().toJSONString());
            map.put("dcep.401.001.01", receive902From401().toJSONString());
            map.put("dcep.227.001.01", receive228().toJSONString());
            map.put("dcep.920.001.01", receive920().toJSONString());
        }

        return map.get(msgType);
    }
    public static JSONObject receive902From401() {
    ...
    public static JSONObject receive902From933() {
        return JSONObject.parseObject( "{\n" +
                "    \"ecnyHead\": {\n" +
                "        \"Sender\": \"C1010311000014\",\n" +
                "        \"DgtlEnvlp\": null,\n" +
    ...
    public static JSONObject receive802From801() {
        return JSONObject.parseObject("{\n" +
                "    \"ecnyHead\": {\n" +
    ...
    public static JSONObject receive920() {
        return JSONObject.parseObject("{\n" +
                "    \"ecnyHead\": {\n" +
                "        \"Sender\": \"C1010311000014\",\n" +
                "        \"DgtlEnvlp\": null,\n" +
    ...
    public static JSONObject receive412() {
        return JSONObject.parseObject("{\n" +
                "\t\"ecnyHead\": {\n" +
                "\t\t\"Sender\": \"C1030644021075\",\n" +
                "\t\t\"SignSN\": \"01\",\n" +
    ...
    public static JSONObject receive228() {
        return JSONObject.parseObject("{\n" +
                "\t\"ecnyHead\": {\n" +
                "\t\t\"Sender\": \"C1030644021075\",\n" +
                "\t\t\"SignSN\": \"01\",\n" +
