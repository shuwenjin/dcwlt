...
//    }
     ...
     List<CheckCollectDO> selectCheckCollect(String batchId);

     List<CheckPathDO> selectCollectSumByMsgType(String batchId);

     List<CheckPathDO> selectCollectSumTotal(String batchId);
     ...
     * @return
     */
     int selectPayTranstionDetailCount(String batchId);
     ...
     * @return
     */
    List<CheckCollectDO> intoFilePayTranstionDetails( String batchId, String fileName, Integer startNum, Integer limit);
     ...
     * @return
     */
     int selectPathDetailForNotMatchCount(String batchId);
     ...
     * @return
     */
     List<CheckResultDO> selectPathDetailForNotMatch(String batchId, Integer offset, Integer limit);
     ...
     * @return
     */
     int selectCollectWithPbocNotFoundCount(String batchId);

     List<CheckResultDO> selectCollectWithPbocNotFound(String batchId, Integer offset, Integer limit);
     ...
     * @return
     */
     List<CheckCollectDO> selectPayTranstionDetailsByMsgId( String batchId, List<String> msgIdList);
     ...
     * @return
     */
     List<CheckResultDO> selectPathDetailByMsgIdList(String batchId, List<String> msgIdList);
