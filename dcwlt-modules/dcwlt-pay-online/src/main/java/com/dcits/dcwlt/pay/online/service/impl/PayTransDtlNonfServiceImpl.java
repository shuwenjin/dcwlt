...
public class PayTransDtlNonfServiceImpl implements IPayTransDtlNonfRepository {
    ...
    private int insertPayTransDtlNonf(PayTransDtlNonfDO payTransDtlNonfDO) {
        return loginMapper.insertPayTransDtlNonf(INSERT_URL, payTransDtlNonfDO);
    }
    ...
    private int updatePayTransDtlNonfInfo(PayTransDtlNonfDO payTransDtlNonfDO){
        return loginMapper.updatePayTransDtlNonf(UPDATE_URL, payTransDtlNonfDO);
    }
    ...
    private List<PayTransDtlNonfDO> queryPayTransDtlNonf(PayTransDtlNonfDO payTransDtlNonfDO){
        return loginMapper.queryPayTransDtlNonf(QUERY_URL, payTransDtlNonfDO);
    }
}
