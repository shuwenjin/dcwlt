...
import com.dcits.dcwlt.common.pay.channel.bankcore.dto.bankcore351100.BankCore351100Req;
 ...
 * @return
 */
//    public <T extends IBankCoreBody, A extends IBankCoreBodyArrayInfo> BankCoreReqMessage<T, A> buildBankCoreMessage(Head head, BankCoreReqHeader codeHeadInfo, BankCore351100Req body, List<A> arrayBody) {
//
//        return BankCoreReqMessage.newInstance(head, codeHeadInfo, body, arrayBody);
//    }
...
//        return BankCoreRspMessage.newInstance(head, coreHead, codeBodyInfo, codeBodyArrayInfo);
//    }
