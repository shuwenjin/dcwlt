 ...
 */
@Component
public class PartyToBeEffectiveRepository implements IPartyToBeEffectiveRepository {
    private static final Logger logger = LoggerFactory.getLogger(PartyToBeEffectiveRepository.class);
