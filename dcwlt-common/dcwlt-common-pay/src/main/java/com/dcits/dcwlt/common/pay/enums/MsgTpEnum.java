...
public enum MsgTpEnum {
    ...
    OMSS991("omss.991.002.01","HTTP通信级探测报文"),
    CCMS903("ccms.903.001.02", "数字证书绑定通知报文"),
    DCEP121("dcep.121.001.01", "钱柜入库出库申请报文"),
    DCEP123("dcep.123.001.01", "钱柜入库出库通知报文"),
    DCEP451("dcep.451.001.01", "钱柜余额预警申请报文"),
    ;
