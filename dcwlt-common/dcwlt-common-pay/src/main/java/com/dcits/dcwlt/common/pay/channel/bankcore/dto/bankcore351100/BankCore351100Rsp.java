...
public class BankCore351100Rsp implements IBankCoreBody {
    ...
    public String toString() {
        return "BankCore351100Rsp [acType1=" + acType1 + ", ac1=" + HiddenUtil.acHidden(ac1) + ", acno1=" + HiddenUtil.acHidden(acno1) + ", name1=" + HiddenUtil.acNameHidden(name1)
                + ", ccy1=" + ccy1 + ", amt1=" + amt1 + ", acType2=" + acType2 + ", ac2=" + HiddenUtil.acHidden(ac2) + ", acno2=" + HiddenUtil.acHidden(acno2)
                + ", name2=" + HiddenUtil.acNameHidden(name2) + ", ccy2=" + ccy2 + ", amt2=" + amt2 + ", exRate=" + exRate + ", ac1Br=" + ac1Br
